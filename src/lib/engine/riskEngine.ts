...
export function computeRiskImpact(input: RiskInput): RiskImpactOutput {
  ...
  return {
    security_risk_score: { name: 'Security Risk', score: clamp(securityScore), evidence: securityEvidence.join('. '), mitigations: securityMitigations },
    legal_complexity_score: { name: 'Legal Complexity', score: clamp(legalScore), evidence: legalEvidence.join('. '), mitigations: legalMitigations },
    esg_risk_score: { name: 'ESG Risk', score: clamp(esgScore), evidence: esgEvidence.join('. '), mitigations: esgMitigations },
    access_risk_score: { name: 'Access Risk', score: clamp(accessScore), evidence: accessEvidence.join('. '), mitigations: accessMitigations },
    data_completeness_score: { name: 'Data Completeness', score: clamp(dataScore), evidence: dataEvidence.join('. '), mitigations: dataMitigations },
  };
}
