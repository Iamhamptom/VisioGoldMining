  ...
  return (
    <div className="flex gap-2 relative z-10">
      <input
        ...
        className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:border-gold/50 focus:outline-none"
      />
      {saved ? (
