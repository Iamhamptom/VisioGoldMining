  ...
  return (
    <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-right-4 duration-500">
      <h2 className="text-lg font-medium text-white mb-2 flex items-center gap-2">
        <MapPin size={20} strokeWidth={1} className="text-gold-400 icon-shine" /> Select Target Area
      </h2>
      ...
      <div className="glass-panel p-4 rounded-xl border-white/10">
        ...
        <input
          ...
          className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:border-gold-400/50 focus:outline-none"
        />
      </div>

      <div className="glass-panel p-4 rounded-xl border-white/10 flex items-center justify-center h-32">
        <div className="text-center">
          <MapPin size={24} strokeWidth={1} className="text-gold-400/50 mx-auto mb-2" />
