...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-bg-dark relative overflow-hidden">
        ...
        >
          ...
          <div className="text-center">
            <h1 className="text-3xl font-display font-bold text-white tracking-wider text-alive">
              Visio<span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-300 via-gold-400 to-gold-200 gold-text-alive">Gold</span>
            </h1>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <input
                ...
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 outline-none focus:border-gold-400/50 focus:ring-1 focus:ring-gold/30 transition-all duration-300 font-light"
              />
            </div>
            <div className="space-y-2">
